...
def train(quick=False):
    ...
    if quick:
        ...
        cfg["output_dir"] = "outputs/baseline_quick"
    ...
    print("=" * 65)
    print("  BASELINE TRAINING - Brain Tumor Segmentation")
    print("=" * 65)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Baseline training for brain tumor segmentation")
